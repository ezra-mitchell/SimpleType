...
<script
	src="/resources/modules/theme/components/theme-changer/theme-changer.component.js"></script>
<script
	...
	<div ng-controller="ThemeEditorController as ctrl">
		<form ng-submit="ctrl.stubSubmit($event)">
			...
			<label>Background Main: <input type="text"
				ng-model="ctrl.theme['--c-bg-main']" /></label> <label>Background Secondary: <input type="text"
				ng-model="ctrl.theme['--c-bg-secondary']" />
			</label> <label>Accent: <input type="text"
				ng-model="ctrl.theme['--c-accent']" /></label> <label>Accent Light:
				<input type="text" ng-model="ctrl.theme['--c-accent-light']" />
			</label> <label>Neutral: <input type="text"
				ng-model="ctrl.theme['--c-neutral']" /></label> <label>Not Typed: <input
				type="text" ng-model="ctrl.theme['--c-not-typed']" />
		...
		<button ng-click="ctrl.updateAvailableThemes()" id="get-themes">Get Themes</button>
		<br> <span ng-repeat="theme in ctrl.availableThemes"
			ng-click="ctrl.getTheme(theme)" class="themeList"> {{theme}} </span> <br> <br>
