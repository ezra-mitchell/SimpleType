...
public class LeaderboardServiceImpl implements LeaderboardService {
	...
	public List<LeaderboardPlaceDTO> postLeaderboardScore(String textJSON, String errorsJSON, String name, int age)
		...
		leaderboard.saveLeaderboardPlace(new LeaderboardPlace(null, name, age, netWPM, accuracy));
	...
	public List<LeaderboardPlaceDTO> getTopLeaderboard(int length) {
		List<LeaderboardPlace> topPlacements = leaderboard.getTopLeaderboardPlaces(length);
