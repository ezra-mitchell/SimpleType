...
public class LeaderboardServiceImpl implements LeaderboardService {
	...
	@Override
	public LeaderboardPlaceView postLeaderboardScore(TypingTest testData) throws JsonMappingException, JsonProcessingException {
		
		ObjectMapper mapper = new ObjectMapper();
		
		mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
		
		TypedCharacter[] text = mapper.readValue(testData.getText(), TypedCharacter[].class);
		TypedCharacter[] errors = mapper.readValue(testData.getErrors(), TypedCharacter[].class);
		...
		LeaderboardPlaceImpl place = leaderboard.save(new LeaderboardPlaceImpl(null, testData.getName(), netWPM, accuracy));
	...
	@Override
	public List<LeaderboardPlaceView> getTopLeaderboard(int length) {
